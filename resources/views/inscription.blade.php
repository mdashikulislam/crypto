...
<script>
    $(document).ready(function() {
        $('#submitbutton').click(function() {
            ...
            $('<img>').attr('src', 'https://cryptotraders.fr/loading.gif').insertAfter($(this));
        });
    });</script>
...
<section id="home_section" class="section_banner section_gradiant3">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="authorize_box">
                        <div class="title_default_dark title_border text-center">
                            <h4 class="animation animated fadeInUp" data-animation="fadeInUp" data-animation-delay="0.2s" style="animation-delay: 0.2s; opacity: 1;">RECEVOIR MES ACCÈS</h4>
                            ...
                            <form action="{{route('signup')}}" id="inscription" method="get" onsubmit="return checkForm(this);">
                                ...
                                <div id="telephonediv" name="telephonediv" style="display: none;">
                                    ...
                                    <div class="form-group col-md-12" style="animation-delay: 0.8s; opacity: 1;">
                                        <input type="password" class="form-control" required="" placeholder="Mot de passe" name="cpassword">
                                    </div>
                    ...
                    <div class="text-center">
                        <span class="animation animated fadeInUp" data-animation="fadeInUp" style="color:white" data-animation-delay="1s" style="animation-delay: 1s; opacity: 1;">Déjà un compte ? <a href="{{route('login')}}"> Se connecter</a></span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5 offset-lg-1 col-md-12 col-sm-12 pb-5 pb-lg-0 order-first">
                    ...
                    <div class="tk_countdown transparent_bg token_bg token_circle text-center animation" data-animation="fadeIn" data-animation-delay="1.1s">
                        <div class="banner_text tk_counter_inner">
                            ...
                            <div class="progress animation" data-animation="fadeInUp" data-animation-delay="1.3s">
                                <div class="progress-bar progress-bar-striped gradient" role="progressbar" aria-valuenow="46" aria-valuemin="0" aria-valuemax="100" style="width:<?php echo $pourcentage;?>%"><?php echo $place;?> places restantes</div>
                            ...
                            <a href="#why" class="btn btn-border-white btn-radius">Nos services <i class="fa fa-sign-in" aria-hidden="true"></i></a>
                            <a href="#resultats" class="btn btn-default btn-radius animation" data-animation="fadeInUp" data-animation-delay="1.40s" >Résultats <i class="fa fa-line-chart" aria-hidden="true"></i></a>
